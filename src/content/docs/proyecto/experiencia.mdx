---
title: Experiencia
description: Este componente muestra la experiencia laboral del desarrollador, cargando los datos de un archivo JSON que contiene la información de las posiciones anteriores, incluyendo el título del trabajo, la empresa, el periodo de trabajo y las responsabilidades.
---

# Componente Experiencia

El **Componente Experiencia** presenta las posiciones laborales anteriores del desarrollador, mostrando el título del trabajo, la empresa, el periodo de empleo y una lista de responsabilidades para cada puesto. El contenido se carga dinámicamente desde un archivo JSON, lo que permite que el componente se actualice fácilmente sin necesidad de modificar el código.
    ...
    fetch('src/datos/experiencia.json')
        ...
        .then((data) => {
            ...
            data.forEach((item) => {
                ...
                item.responsabilidades.forEach((resp) => {
...
La sección que contiene la experiencia tiene las siguientes clases:
